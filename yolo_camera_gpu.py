...
def stream_yolo_gpu(show_fps=True, imgsz=640):
    ...
    """
    print("[INFO] Comprobando disponibilidad de GPU (CUDA)...")
    if not torch.cuda.is_available():
        print("[ADVERTENCIA] CUDA no está disponible. El modelo no podrá correr en GPU y probablemente use la CPU.")
    else:
    ...
    try:
        while True:
            ...
            cv2.imshow("YOLO Preview (GPU)", annotated_frame)
